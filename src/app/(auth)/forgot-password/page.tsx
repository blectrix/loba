...
const ForgotPasswordPage = () => {
    ...
    return (
        ...
        <form
            ...
            className="w-full sm:justify-center sm:w-[400px] space-y-3 mb-5 flex flex-col justify-center items-center"
        >
            <ThemeModeToggle />
            <Link
                href="/"
            ...
            <div className='flex flex-row gap-4 items-center text-sm justify-center'>
            <Button
            type="submit"
            className="w-fit p-4"
            size="sm"
            disabled={isLoading}
            >
            {!isLoading ? 'Send recovery email' : <Loader />}
            </Button>
            </div>
