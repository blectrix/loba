...
import LobaProfileIcon from '../icons/lobaProfileIcon';
    ...
    <div className="flex gap-4 flex-col">
      ...
      <div className="flex flex-col gap-2">
        ...
        {subscription?.status !== 'active' && (
          <small className="text-muted-foreground mb-2 self-center">
            To fully customize your workspace, you need to be on a <b>Pro Plan</b>
          </small>
        )}
      </div>
      <>
        ...
        <p className="flex items-center gap-2 mt-6 justify-center">
          <CreditCard size={20} /> Billing & Plan
        </p>
        <Separator />
        <p className="text-muted-foreground text-center">
          You are currently on a{' '}
          <b>{subscription?.status === 'active' ? 'Pro' : 'Free'} Plan</b>
        </p>
        <Link
          href="/"
          target="_blank"
          className="text-muted-foreground text-center justify-center text-sm flex flex-row items-center gap-2"
        >
