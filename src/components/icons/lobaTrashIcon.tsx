...
interface LobaTrashIconProps {}
const LobaTrashIcon: FC<LobaTrashIconProps> = () => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <path
        ...
        className={`fill-primary/70 text-xl transition-all group-hover/native:fill-green-400`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        className={`fill-background transition-all group-hover/native:fill-primary dark:group-hover/native:fill-foreground`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      <path
        ...
        className={`fill-primary/60 transition-all group-hover/native:fill-green-500`}
      />
    </svg>
  );
};

export default LobaTrashIcon;
