...
interface LobaPageIconProps {}
const LobaPageIcon: FC<LobaPageIconProps> = () => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      <path
        ...
        className={`fill-background  transition-all group-hover/native:fill-background`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      <path
        ...
        className={`fill-primary/70 transition-all group-hover/native:fill-background`}
      />
    </svg>
  );
};

export default LobaPageIcon;
