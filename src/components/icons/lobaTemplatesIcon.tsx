...
interface LobaTemplateIconProps {}
const LobaTemplateIcon: FC<LobaTemplateIconProps> = () => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <path
        ...
        className={`fill-primary/70 transition-all group-hover/native:fill-primary dark:group-hover/native:fill-foreground`}
      />
      <path
        ...
        className={`fill-background text-xl transition-all group-hover/native:fill-green-400`}
      />
      <path
...
export default LobaTemplateIcon;
